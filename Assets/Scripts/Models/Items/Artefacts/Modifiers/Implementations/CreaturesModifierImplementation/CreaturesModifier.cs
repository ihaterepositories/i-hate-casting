...
using Models.Items.Artefacts.Modifiers.Base;
using Models.Items.Artefacts.Modifiers.Implementations.CreaturesModifierImplementation.ScriptableObjects;
...
namespace Models.Items.Artefacts.Modifiers.Implementations.CreaturesModifierImplementation
{

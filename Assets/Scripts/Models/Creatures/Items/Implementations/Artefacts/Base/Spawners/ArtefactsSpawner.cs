...
namespace Models.Creatures.Items.Implementations.Artefacts.Base.Spawners
{
    /// <summary>
    ...
    public class ArtefactsSpawner : MonoBehaviour
    {
        ...
        /// </summary>
        public void RunArtefactSelectionProcess(ArtefactsLoadType loadType)
        {
            _castingMenu.OpenCastingPuzzleThenIfSolved(() =>
            {
                LoadArtefacts(loadType, artefacts => _selectionMenu.OpenMenuToSelect(artefacts));
            });
        }
        ...
        private void LoadArtefacts(ArtefactsLoadType loadType, Action<List<SelectableItemSo>> onLoadedCallback)
        {
